...
public final class Configuration {
    ...
    private void readConfiguration() throws InvalidConfigurationException {
        ...
        /* In file from internal storage. NOTE: Changed from previously using a raw resource */
        ...
        BufferedSource configSource = Okio.buffer(fileSource);
	...
	/* DJT: added.. */
        ...
        /* DJT: Changed the following to not be required, since the API generates an error when the scope 
	 * param is included.
	 *  mScope = getRequiredConfigString("authorization_scope"); */
        mScope = getConfigString("authorization_scope");
        mRedirectUri = getRequiredConfigUri("redirect_uri");

        Log.i(TAG, "From config mScope: " + mScope);
