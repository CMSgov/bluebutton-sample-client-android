...
public class TokenActivity extends AppCompatActivity {
    ...
    private void displayNotAuthorized(String explanation) {
        Log.e(TAG, "displayNotAuthorized()");
    ...
    private void exchangeAuthorizationCode(AuthorizationResponse authorizationResponse) {
        Log.e(TAG, "exchangeAuthorizationCode()");
...
@MainThread
    ...
    private void handleAccessTokenResponse(
        ...
        Log.e(TAG, "handleAccessTokenResponse()");
    ...
    private void handleCodeExchangeResponse(
        ...
        Log.e(TAG, "handleCodeExchangeResponse()");
        mStateManager.updateAfterTokenResponse(tokenResponse, authException);
        if (!mStateManager.getCurrent().isAuthorized()) {
	...
	// Removed if, so that configuration is also cleared.
